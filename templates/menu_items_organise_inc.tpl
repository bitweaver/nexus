	...
	{if $item.last}</ul>{else}
		<li>
			<div class="{cycle values='even,odd'} clear">
				...
				<a href="{$smarty.const.NEXUS_PKG_URL}menu_sort.php?sort_menu={$menuId}&amp;menu_id={$item.menu_id}&amp;item_id={$item.item_id}&amp;move_item=s&amp;tab=organise">{biticon iforce=icon ipackage="icons" iname="go-down" iexplain="move down" style="float:right"}</a>
				<a href="{$smarty.const.NEXUS_PKG_URL}menu_sort.php?sort_menu={$menuId}&amp;menu_id={$item.menu_id}&amp;item_id={$item.item_id}&amp;move_item=n&amp;tab=organise">{biticon iforce=icon ipackage="icons" iname="go-up" iexplain="move up" style="float:right"}</a>
				<a href="{$smarty.const.NEXUS_PKG_URL}menu_sort.php?sort_menu={$menuId}&amp;menu_id={$item.menu_id}&amp;item_id={$item.item_id}&amp;move_item=w&amp;tab=organise">{biticon iforce=icon ipackage="icons" iname="go-previous" iexplain="move left" style="float:right"}</a>
