...
<ul>
	...
	{if $gNexus->mInfo.menu_id}
		<li><a class="item" href="{$smarty.const.NEXUS_PKG_URL}menu_items.php?menu_id={$gNexus->mInfo.menu_id}">{biticon ipackage="icons" iname="accessories-text-editor" iexplain="Edit Items" ilocation=menu}</a></li>
